...
A [Cookiecutter](https://github.com/cookiecutter/cookiecutter) template for creating Python extension modules in Zig using [Pydust](https://github.com/fulcrum-so/ziggy-pydust).
...
```bash
cookiecutter gh:fulcrum-so/ziggy-pydust-template
# Or if running locally:
# cookiecutter /path/to/ziggy-pydust-template
```
...
- [Pydust Documentation](https://pydust.fulcrum.so/latest/getting_started/)
