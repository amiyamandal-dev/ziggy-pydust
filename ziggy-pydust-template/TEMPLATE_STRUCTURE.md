...
This document describes the structure of the ziggy-pydust-template cookiecutter template after cleanup.
...
1. **User runs**: `cookiecutter /path/to/ziggy-pydust-template`
