...
The following files from the original ziggy-pydust-template were removed as they are no longer needed:
...
```
ziggy-pydust-template/                    (Root - cookiecutter configuration)
