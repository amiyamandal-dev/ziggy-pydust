...
class DependencyManager:
    ...
    def __init__(self, project_root: Path = Path.cwd()):
        ...
        self.deps_file = project_root / "pydust_deps.json"

    def load_dependencies(self) -> dict[str, Dependency]:
        """Load existing dependencies from pydust_deps.json."""
    ...
    def save_dependencies(self, dependencies: dict[str, Dependency]) -> None:
        """Save dependencies to pydust_deps.json."""
